"""
1)Comprehension
2)Indentation scope of veriables & section
3) Built-in function : min , max , len, split ....

create matrix using comprehension
output : [[0, 1, 2] [0, 1, 2] [0, 1, 2]]

write a program to create dictionary of name , salary, designation from the list
exa : ['parth', 20000, 'programer']
output : {'name':'parth', 'designation':'programer', 'salery':20000}

Write a program to create list of dictionary to store user information

example : [['parth', 20000, 'Programer'], ['sri', 400000, 'Sr. programer']]
output :
[{'name':'parth', 'designation':'programer', 'salery':20000},
{'name':'sri', 'designation':'Sr. programer', 'salery':40000}


# to comment all statement user ctrl+?
# # hti
# # thoe
"""
